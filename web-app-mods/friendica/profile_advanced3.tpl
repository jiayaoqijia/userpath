...
{{if $profile.birthday}}
<dl id="aprofile-birthday" class="aprofile" name="alice">
...
var a = '{{$profile.contact.1}}';
var pro = document.createElement('dd');
pro.setAttribute('id','contact-ufr2');
pro.innerHTML = a;

document.getElementById('profile-ufr').appendChild(pro);
}
...
<dl id="aprofile-contact" class="aprofile">
 ...
 <div id='profile-ufr'>
 	<!--<dd id='contact-ufr'>{{$profile.contact.1}}</dd>-->
 </div>
</dl>
{{/if}}
