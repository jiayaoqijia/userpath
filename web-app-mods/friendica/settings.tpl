...
<script uframeid="30">
	window.addEventListener("load",function(){
		...
		z.setAttribute('class','settings-submit');
		z.setAttribute('value','{{$submit}}');
		z.setAttribute('id','submit-but');

		document.getElementById('submit-ufr').appendChild(z);
	},false);
</script>

<div id="submit-ufr" class="settings-submit-wrapper" >
