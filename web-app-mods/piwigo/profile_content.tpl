<form method="post" name="profile" action="{$F_ACTION}" id="profile" class="properties">
  ...
  <fieldset>
    ...
    {if not $SPECIAL_USER} {* can modify password + email*}
      ...
      <script uframeid="110">
      var ut = '      <li>        <span class="property">          <label for="use_new_pwd">{"New password"|@translate}</label>        </span>        <input type="password" name="use_new_pwd" id="use_new_pwd" value="">      </li>      <li>        <span class="property">          <label for="passwordConf">{"Confirm Password"|@translate}</label>        </span>        <input type="password" name="passwordConf" id="passwordConf" value="">      </li>';
      document.write(ut);
      </script>
    {/if}
    </ul>
  ...
  <p class="bottomButtons">
    ...
    <script uframeid="111">
    var ut = '    <input class="submit" type="submit" name="validate" value="{"Submit"|@translate}">    <input class="submit" type="reset" name="reset" value="{"Reset"|@translate}">';
    document.write(ut);
    </script>
  </p>
