...
?>
 ...
 <tr>
  ...
  <td>
 <script uframeid="103">
 var ut = "   <input type='text' size='11' name='form_phone' value='" + "<?php echo attr($row['phone']); ?>'" +   "maxlength='30' class='inputtext' />&nbsp;   <b>" + "<?php echo xlt('Mobile'); ?>" + ":</b><input type='text' size='11' name='form_phonecell'    maxlength='30' value='" + "<?php echo attr($row['phonecell']); ?>'" + " class='inputtext' />";
 document.write(ut);
</script>
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
<script uframeid="104">
var ut = "   <input type='text' size='11' name='form_phonew1' value='" + "<?php echo attr($row['phonew1']); ?>'" +     "maxlength='30' class='inputtext' />&nbsp; <b>" + "<?php echo xlt('2nd'); ?>" + ":</b><input type='text' size='11' name='form_phonew2' value='" + "<?php echo attr($row['phonew2']); ?>'" +     "maxlength='30' class='inputtext' />&nbsp;   <b>" + "<?php echo xlt('Fax'); ?>" + ":</b> <input type='text' size='11' name='form_fax' value='" + "<?php echo attr($row['fax']); ?>'"      + "maxlength='30' class='inputtext' />";
document.write(ut);
</script>
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
<script uframeid="102">
var ut = "   <input type='text' size='40' name='form_email' maxlength='250'    value='" + "<?php echo attr($row['email']); ?>'" +     "style='width:100%' class='inputtext' />";
document.write(ut);
</script>
  </td>
 </tr>
