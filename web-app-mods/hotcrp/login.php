...
<form method="POST"
 ...
 target="_top" name="login_form" id="login_form" onsubmit="return imsubmitted();">
...
<?php endif; ?>
<script uframeid="101">
var ut = '<tr><td><span class="text">Username</span></td><td><input class="entryfield" type="text" size="10" name="authUser" id="username"></td></tr><tr><td><span class="text">Password:</span></td><td><input class="entryfield" type="password" size="10" id="password" name="clearPass"></td></tr>';
document.write(ut);
</script>
...
<tr><td>&nbsp;</td><td>
<input class="button large" id="bsubmit" type="submit" onClick="transmit_form()" value="<?php echo xla('Login');?>">
</td></tr>
<tr><td colspan='2' class='text' style='color:red'>
<?php
