...
?>
 ...
 <tr>
  ...
  <td>
 <script uframeid="109">
 var ut = "   <input type='text' size='40' name='form_title' value='" + "<?php echo attr($irow['title']) ?>" + "' style='width:100%' />";
 document.write(ut);
</script>
  </td>
 </tr>
 ...
 <tr id='row_diagnosis'>
  ...
  <td>
 <script uframeid="110">
 var ut = "   <input type='text' size='50' name='form_diagnosis'    value='" + "<?php echo attr($irow['diagnosis']) ?>" + "' onclick='sel_diagnosis()'    title='" + "<?php echo xla('Click to select or change diagnoses'); ?>" + "'    style='width:100%' readonly />";
 document.write(ut);
    </script>
  </td>
 </tr>
