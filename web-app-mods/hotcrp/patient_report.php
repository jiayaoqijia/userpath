...
<br>
<script uframeid="111">
var ut = '<input type="button" class="generateCCR" value="' + '<?php xl('View/Print','e'); ?>' + '" /><input type="button" class="generateCCR_download_p" value="' + '<?php echo xl('Download'); ?>' + '" />';
document.write(ut);
</script>
...
<br/>
<script uframeid="112">
var ut = '<input type="button" class="viewCCD" value="' + '<?php xl('View/Print','e'); ?>' + '" /><input type="button" class="viewCCD_download" value="' + '<?php echo htmlspecialchars( xl('Download', ENT_QUOTES)); ?>' + '" />';
document.write(ut);
</script>
...
<br>
<script uframeid="115">
var ut = '<input type="button" class="genreport" value="' + '<?php xl('Generate Report','e'); ?>' + '" />&nbsp;<input type="button" class="genpdfrep" value="' + '<?php xl('Download PDF','e'); ?>' + '" />';
document.write(ut);
</script>
