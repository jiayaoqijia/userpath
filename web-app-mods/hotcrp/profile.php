...
?>
    <script uframeid="105">
    var ut = '<input type="text" class="textlite" name="uemail" id="account_d" size="52" value="aliceisnotbob@gmail.com" onchange="hiliter(this)">';
document.write(ut);
    </script>
<?php
//else if (!$newProfile) {
...
if (!$newProfile && !isset($Opt["ldapLogin"]) && !isset($Opt["httpAuthLogin"])) {
  ...
  <div class='", feclass('password'), "'>";
?>
<script uframeid="103">
/*    <input class='textlite fn' type='password' name='upassword' size='24' value=\"", crpformvalue('upassword', 'password'), "\" onchange='hiliter(this)' />";
    if ($Me->privChair)
 ...
 */
var ut = '<input class="textlite fn" type="password" name="upassword" size="24" value="srp auth handler" onchange="hiliter(this)"> <input class="textlite fx" type="text" name="upasswordt" size="24" value="srp auth handler" onchange="hiliter(this)">';
document.write(ut);
</script>
<?php
    echo "</div>
...
/*<div class='", feclass('password'), "'>", textinput("upassword2", crpformvalue("upassword2", "password"), 24, false, true), "</div>*/
    var ut = '<input type="password" class="textlite" name="upassword2" size="24" value="srp auth handler" onchange="hiliter(this)">';
    document.write(ut);
</script>
<?php
echo "</div>
...
?>
    <script uframeid="106">
    var ut = '<div class="f-ix"><div class="f-c">Phone <span class="f-cx">(optional)</span></div><div class="f-e"><input type="text" class="textlite" name="voicePhoneNumber" size="24" value="123456789" onchange="hiliter(this)"></div></div>';
   document.write(ut); 
    </script>
<?php
    echo "<div class='clear'></div></div>\n";
