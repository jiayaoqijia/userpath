	...
	<table width="1004" border="0" style="border:1px solid black" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	   ...
	   <script>
		...
		?>
          <script uframeid="107">
          var ut = '		<input type="text" name="check_number"  style="width:140px;' + '<?php echo $CheckDisplay;?>' + '"  autocomplete="off"  value="' + '<?php echo htmlspecialchars($CheckNumber);?>' + '"  onKeyUp="ConvertToUpperCase(this)"  id="check_number"  class="text "   />';
          document.write(ut);
          </script>
	  ...
	  <tr>
        ...
        <td align="left">
          <script uframeid="108">
          var ut = '<input   type="text" name="payment_amount"   autocomplete="off"  id="payment_amount"  onchange="ValidateNumeric(this);' + '<?php echo $screen=='new_payment'?'FillUnappliedAmount();':'FillAmount();';?>' + '"  value="' + '<?php echo $screen=='new_payment'?htmlspecialchars('0.00'):htmlspecialchars($PayTotal);?>' + '"  style="text-align:right"    class="class1 text "   />';
          document.write(ut);
    </script>
    </td>
	    <td align="left" ></td>
