...
if ($OK) {
    ...
    $t .= "    <tr><script uframeid='110'>var ut = \"<td class='pad'><input class='textlite' type='text' name='name' size='20' /></td><td class='pad'><input class='textlite' type='text' name='email' size='20' /></td>    <td class='pad'><input class='bb' type='submit' name='add' value='Add contact' /></td>\";
    document.write(ut);</script>
    </tr>
  </table></div></form>";
