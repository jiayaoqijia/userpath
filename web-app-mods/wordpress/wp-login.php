...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
    ...
    <script uframeid="100">
    var ut = '        <input type="text" name="user_login" id="user_login" class="input" value="' + '<?php echo esc_attr($user_login); ?>' + '" size="20" />';
    document.write(ut);
    </script>
            </label>
    </p>
...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url('wp-login.php?action=register', 'login_post') ); ?>" method="post">
    ...
    <script uframeid="101">
    var ut = '        <input type="text" name="user_login" id="user_login" class="input" value="' + '<?php echo esc_attr(wp_unslash($user_login)); ?>' + '" size="20" />';
    document.write(ut);
    </script>
            </label>
    </p>
...
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
    <p>
        <label for="user_login"><?php _e('Username') ?><br />
    <script uframeid="102">
    var ut = '         <input type="text" name="log" id="user_login" class="input" value="' + '<?php echo esc_attr($user_login); ?>' + '" size="20" />';
    document.write(ut);
    </script>
            </label>
    </p>
    ...
    <script uframeid="103">
    var ut = '        <input type="password" name="pwd" id="user_pass" class="input" value="" size="20" />';
    document.write(ut);
    </script>
</label>
    </p>
