...
<table class="form-table">
	...
	<tr class="form-field form-required">
        ...
        <td>
<script uframeid="115">
var ut = '<input name="email" type="text" id="email" value="' + '<?php echo esc_attr($new_user_email); ?>' + '" />';
document.write(ut);
    </script>
    </td>
	</tr>
...
<script uframeid="116">
var ut = '            <input name="pass1" type="password" id="pass1" autocomplete="off" />';
document.write(ut);
</script>
		</td>
	</tr>
	<tr class="form-field form-required">
		...
		<td>
<script uframeid1="117">
var ut = '        <input name="pass2" type="password" id="pass2" autocomplete="off" />';
document.write(ut);
</script>
		<br />
