...
<tr>
    ...
    <td>
<script uframeid="111">
            var ut = '<input type="text" name="email" id="email" value="' + '<?php echo esc_attr($profileuser->user_email) ?>' + '" class="regular-text" />';
            document.write(ut);
</script>
	<?php
	$new_email = get_option( $current_user->ID . '_new_email' );
...
<tr id="password">
    ...
    <script uframeid="112">
    var ut = '        <input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /> ';
document.write(ut);
</script>
...
<tr>
	...
	<td>
    <script uframeid="112">
    var ut = '    <input name="pass2" type="password" id="pass2" size="16" value="" autocomplete="off" /> ';
document.write(ut);
</script>
