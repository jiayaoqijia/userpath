...
/*<tr>
  ...
  var ut = ' <tbody><tr>              <td class="fieldKey">Current Password:</td>                      <td class="fieldValue"><input type="password" name="password_current" maxlength="40">&nbsp;<span class="inputRequirement">*</span></td>                            </tr>                                  <tr>                                           <td class="fieldKey">New Password:</td>                                                  <td class="fieldValue"><input type="password" name="password_new" maxlength="40">&nbsp;<span class="inputRequirement">*</span></td>                                                        </tr>                                                              <tr>                                                                       <td class="fieldKey">Password Confirmation:</td>                                                                              <td class="fieldValue"><input type="password" name="password_confirmation" maxlength="40">&nbsp;<span class="inputRequirement">*</span></td>                                                                                    </tr>';
  document.write(ut);
        </script>
    </table>
  </div>
