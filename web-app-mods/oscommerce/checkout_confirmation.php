...
?>
  ...
  <script uframeis="108">
var ut = '<button id="tdb5" type="submit" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-primary" role="button" aria-disabled="false"><span class="ui-button-icon-primary ui-icon ui-icon-check"></span><span class="ui-button-text">Confirm Order</span></button>';
document.write(ut);
  </script>
    </div>
  </div>
