...
?>
      ...
      <tr>
        ...
        <td class="fieldValue">
  <script uframeid="102">
  var email =  '<?php echo $account['customers_email_address']; ?>';
  var ut ='<input type="text" name="email_address" value="' + email + '">&nbsp;<span class="inputRequirement">*</span>';
  ...
  document.write(ut);
      ...
      <tr>
        ...
        <td class="fieldValue">
  <script uframeid="103">
  var phone =  '<?php echo $account['customers_telephone']?>';
  var ut ='<input type="text" name="telephone" value="' + phone + '">&nbsp;<span class="inputRequirement">*</span>';
