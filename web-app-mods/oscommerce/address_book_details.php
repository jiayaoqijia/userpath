...
?>
      ...
      <tr>
        ...
        <td class="fieldValue">
<script uframeid="104">
var address = '<?php echo $entry["entry_street_address"]; ?>';
var ut = '<input type="text" name="street_address" value="' + address + '">&nbsp;<span class="inputRequirement">*</span>';
/*<?php echo tep_draw_input_field('street_address', (isset($entry['entry_street_address']) ? $entry['entry_street_address'] : '')) . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_TEXT . '</span>': ''); ?>*/
document.write(ut);
  </script>
  </td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue">
  <script uframeid="105">
  var post = '<?php echo $entry['entry_postcode']?>';
var ut = '<input type="text" name="postcode" value="' + post + '">&nbsp;<span class="inputRequirement">*</span>';
/*<?php echo tep_draw_input_field('postcode', (isset($entry['entry_postcode']) ? $entry['entry_postcode'] : '')) . '&nbsp;' . (tep_not_null(ENTRY_POST_CODE_TEXT) ? '<span class="inputRequirement">' . ENTRY_POST_CODE_TEXT . '</span>': ''); ?>*/
document.write(ut);
  </script>
