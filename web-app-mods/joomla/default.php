...
<script uframeid="101">
var ut = '                    <input name="username" tabindex="1" id="mod-login-username" type="text" class="input-medium" placeholder="' + '<?php echo JText::_('JGLOBAL_USERNAME'); ?>' + '" size="15"/>';
document.write(ut);
</script>
...
<script uframeid="102">
var ut = '                    <input name="passwd" tabindex="2" id="mod-login-password" type="password" class="input-medium" placeholder="' + '<?php echo JText::_('JGLOBAL_PASSWORD'); ?>' + '" size="15"/>';
document.write(ut);
</script>
