...
<script uframeid="112">
var ut = '<?php $content = str_replace(PHP_EOL, '', $this->loadTemplate('groups')); echo $content; ?>';
document.write(ut);
</script>
                <?php echo JHtml::_('bootstrap.endTab'); ?>
            <?php endif; ?>
...
<?php //echo $field->input; ?>
<script uframeid="111">
var ut = '<?php $content = str_replace(PHP_EOL, '', $field->input); echo $content; ?>';
document.write(ut);
</script>
                            </div>
                        </div>
