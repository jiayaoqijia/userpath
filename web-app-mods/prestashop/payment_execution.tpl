...
<script uframeid="114">
var ut = '	<input type="submit" value="{l s="Place my order" mod="bankwire"}" class="exclusive_large" />	<a href="{$link->getPageLink("order", true, NULL, "step=3")|escape:"html"}" class="button_large">{l s="Other payment methods" mod="bankwire"}</a>';
document.write(ut);
</script>
